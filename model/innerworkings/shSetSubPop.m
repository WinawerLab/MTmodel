...
% Replace MEX destructive write with native 1-based indexing.
% The C MEX used a 0-based startIndex, so MATLAB index starts at startIndex+1.
pop(startIndex+1 : startIndex+numel(subPop)) = subPop(:);
