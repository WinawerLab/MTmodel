...
function pars = shPars
    ...
    pars.rgc.centerSigma = 0.8;                     % Center sigma (pixels) for spatial filtering.
    pars.rgc.surroundSigma = 2.0;                   % Surround sigma (pixels) for spatial filtering.
    pars.rgc.surroundWeight = 0;                    % 0 preserves legacy behavior; increase to enable center-surround antagonism.
    pars.rgc.temporalSigma = 0;                     % Temporal sigma (frames). 0 means no temporal smoothing.
