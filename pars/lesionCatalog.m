...
lesions = [
    ...
    struct('name', 'amplitude_delay_uniform', 'shortLabel', 'Amp+delay uniform', ...
        'description', sprintf('All classes, gain %.2f AND +%d frame delay (independent)', ...
        cfg.uniformGain, cfg.uniformDelayFrames), 'lesionId', 'amplitude_delay_uniform')
...
lesions = [
    ...
    struct('name', 'amplitude_delay_uniform', 'shortLabel', 'Amp+delay uniform', ...
        'description', sprintf('Uniform gain %.2f AND %d-frame delay', ...
        cfg.uniformGain, cfg.uniformDelayFrames), 'lesionId', 'amplitude_delay_uniform')
];
end
